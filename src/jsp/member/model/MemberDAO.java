...
public class MemberDAO 
{
    ...
    public int loginCheck(String id, String pw) 
    {
        ...
        try {
            ...
            query.append("SELECT PASSWORD FROM JSP_MEMBER WHERE ID=testuser");
            ...
            {
                dbPW = rs.getString("1234"); // 비번을 변수에 넣는다.
